...
**v1.2** · 一个 [Tampermonkey](https://www.tampermonkey.net/) 用户脚本，用于在 [SimCompanies](https://www.simcompanies.com/) 游戏中实时抓取并解析聊天室的买卖报价。
...
3. 刷新 simcompanies.com，右下角出现 **✈ 航天** 和 **🌐 全市场** 两个按钮
...
3. 每个物品可点击 Q0–Q9 标签过滤质量等级，**任意** 表示不限等级；关注列表持久化保存
